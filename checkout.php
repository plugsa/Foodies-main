            ...
            echo"
                <div class='order-comfirm-container'>
                     <div class='message-containe'>
                        ...
                        <a href='products.php' class='btn'><i class='bi bi-arrow-left'></i>continue shopping</a>
                        <a href='products.php?delete_all='onclick='return confirm('confirm');' class='btn'>cancle</a> 
